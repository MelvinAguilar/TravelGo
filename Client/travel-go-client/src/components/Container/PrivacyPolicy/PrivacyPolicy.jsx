...
const PrivacyPolicy = ({ className, ...rest }) => {
  return (
    <section className={classes["Privacy-policy"]} {...rest}>
      ...
      <p>
        ...
        decided to use our Service, the test website.
      </p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at test, unless otherwise
      ...
      <p>
        ...
        but not limited to your name, Email address, phone number, Address,
        State, Province, ZIP/Postal code, City. The information that we collect
