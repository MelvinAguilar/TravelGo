  ...
  return (
    <section className={classes["TermsOfService"]} {...rest}>
      ...
      <p>
        ...
        If you are under 18 years old, you are not permitted to register for the
        Website or use any of its services and/or products.
      </p>
      <p>
      ...
      <h2 className={classes["TermsOfService__subtitle"]}>2. Intellectual property</h2>
      <p>
      ...
      <h3 className={classes["TermsOfService__subtitle"]}>3. Links To Other Web Sites</h3>
      <p>
      ...
      <p>
        <span className={classes["TermsOfService__warning"]}>Warning: </span>
